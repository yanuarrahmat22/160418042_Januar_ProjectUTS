...
class FasilitasDetailViewModel(application: Application): AndroidViewModel(application)  {
    ...
    fun fetch(id:String) {
        ...
        var fasilitasList = arrayListOf<Fasilitas>(fasilitas1,fasilitas2,fasilitas3,fasilitas4,fasilitas5,fasilitas6,fasilitas7,fasilitas8,fasilitas9,fasilitas10,fasilitas11)
