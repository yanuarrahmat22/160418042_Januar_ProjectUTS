 ...
 * Use the [PeminjamanFasilitasFragment.newInstance] factory method to
...
class PeminjamanFasilitasFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment PeminjamanFasilitasFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            PeminjamanFasilitasFragment().apply {
